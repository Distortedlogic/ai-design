...
## 1. WeChat article cover / article header image
...
**Key design elements**:
- Visual impact first (users skim quickly through the feed)
- Minimal or no text (the WeChat title will be overlaid)
- Moderate color saturation (the WeChat reading environment leans white)
- Avoid excessive detail (must remain identifiable as a thumbnail)
...
## 2. In-article illustration / concept illustration

**Specs**:
- 16:9 (1200×675px) most general
- 1:1 (800×800px) for emphasis
- 4:3 (1200×900px) for information-dense content

**Key design elements**:
- Serves the article's argument, not decoration
- Forms a visual rhythm with the surrounding context
- Concise expression of one core concept
- AI generation preferred; HTML screenshot only for precise data tables

**Recommended styles**: chosen based on article tone, commonly 01/04/10/17/18
...
- Visual leading lines (the user's reading path)
- Appropriate use of icons/charts to aid understanding
...
**Key design elements**:
- One core message per slide (don't pile things up)
- Clear type-size hierarchy (title 40pt+ / body 24pt+ / annotation 16pt+)
...
**Key design elements**:
- Convey core value within 5 seconds of the first screen
...
- Consistency with the system design language
- Standard handling of status bar / navigation bar / tab bar
- Moderate information density (don't pack mobile screens too tightly)
...
- A small amount of text is fine (but no more than 20% of the frame)
...
**Scenario**: WeChat article cover, introducing an AI coding tool, want it to feel professional but warm.

**Step 1**: Pick a style → 17 Takram (professional + warmth)
**Step 2**: Take the Takram prompt DNA + WeChat cover template
