#!/usr/bin/env node
/**
 * export_deck_pdf.mjs — Export multi-file slide deck as a single vector PDF
 *
 * Usage:
 ...
 *   - Zero visual loss (PDF is what the browser prints)
 *
 * Trade-off:
 *   - PDF text is no longer editable (changes must go back to HTML)
 *
