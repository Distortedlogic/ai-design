#!/usr/bin/env python3
"""
verify.py — Playwright wrapper for verifying HTML produced by ai-design
...
Usage:
    ...
    python verify.py deck.html --slides 10                  # Slideshow mode: screenshot each slide (first 10)
...
def main():
    ...
    parser.add_argument("--slides", type=int, default=0,
                        help="Slideshow mode: capture first N slides (HTML must support ArrowRight to advance)")
    parser.add_argument("--output", default=None,
                        help="Output directory (defaults to screenshots/ in the HTML's directory)")
