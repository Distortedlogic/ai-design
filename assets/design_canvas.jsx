 ...
 *
 * Used to display 2+ static design variations for users to compare and choose.
 ...
 *   </DesignCanvas>
 *
 * Use with React+Babel. Place in an appropriate script, then window.DesignCanvas/window.Variation are available.
 */
