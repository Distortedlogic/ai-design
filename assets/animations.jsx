 ...
 * - Stage: Whole animation container, provides time + controls
 * - Sprite: Time segment, displays within start/end, provides local progress
 ...
 *   </Stage>
 *
 * Inside Sprite child components, use useSprite() to read current segment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // expoOut: Anthropic-level main easing (cubic-bezier(0.16, 1, 0.3, 1))
