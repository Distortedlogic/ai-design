/**
 * <deck-stage> — HTML slideshow shell web component
 *
 * Features:
...
(function() {
  ...
  class DeckStage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // the parser may not have finished processing child <section> elements yet, and
      // querySelectorAll would return empty. Defer to the next event loop to ensure
      // all child nodes have been parsed.
      const init = () => {
        this._collectSlides();
      ...
      if (this.ownerDocument.readyState === 'loading') {
        ...
        // Document already parsed (script at body bottom or defer); collect on next frame
